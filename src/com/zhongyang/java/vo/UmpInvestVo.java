...
public class UmpInvestVo extends UmpResultVO{
	...
	public String toString() {
		return "UmpInvestVo [order_id=" + order_id + ", mer_date=" + mer_date + ", trade_no=" + trade_no
				+ ", mer_check_date=" + mer_check_date + ", ret_code=" + ret_code + ", ret_msg=" + ret_msg + "]";
	}
}
